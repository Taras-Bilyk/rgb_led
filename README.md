...
## 🤓 Опис:
це простий тест на працездатність ESP32 із прошивкою micropython. таккож ідеально для для навчання основам micropython і роботи із багатокольорними LED.
